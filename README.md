...
**Martify** là giải pháp phần mềm desktop dành cho các siêu thị mini và cửa hàng tiện lợi. Ứng dụng được xây dựng trên nền tảng **WPF (.NET 8)** với kiến trúc **MVVM**, tập trung vào trải nghiệm người dùng hiện đại (UI/UX), hiệu năng và bán hàng.
...
| **Nhân viên (Staff)** | `staff` | `123` | Chỉ truy cập Bán hàng & Tra cứu |
