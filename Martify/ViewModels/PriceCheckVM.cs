    ...
    public class PriceCheckVM : BaseVM, IDisposable
    {
        ...
        public string StockStatusDisplay
        {
            get
            {
                ...
                if (StockQuantity <= 10) return "Sắp hết hàng";
                return "Còn";
            }
        }
        ...
        public PriceCheckVM()
        {
            ...
            StatusMessage = "Đang kh?i t?o camera...";
            LoadCameras();
        }
        #endregion
        ...
        public void StartCamera(string monikerString)
        {
            try
            {
                ...
                _isScanning = true;
                IsCameraActive = true;
                StatusMessage = "Đưa m? QR/Barcode vào khung h?nh đ? quét...";
            }
            catch (Exception ex)
            {
                StatusMessage = $"L?i khi kh?i đ?ng camera: {ex.Message}";
